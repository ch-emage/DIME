...
from widgets import FrameView, BTN_NEUTRAL, BTN_REC_IDLE, BTN_REC_ACTIVE
...
class SaveVideoDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        for rb in (self._rb_existing, self._rb_new):
            rb.setStyleSheet("color:#eee; font-size:13px;")
            layout.addWidget(rb)
        ...
        lbl.setStyleSheet("color:#aaa; font-size:12px; min-width:130px;")
...
class RecordSubTab(QWidget):
    ...
    def _build_ui(self):
        ...
        banner.setStyleSheet(
            "background:#1a2a1a; color:#8bc34a; font-size:12px; "
        ...
        self.btn_connect.setStyleSheet(
            "QPushButton { background:#1a5276; color:white; font-weight:bold; border-radius:6px; }"
        ...
        self.lbl_cam.setStyleSheet("color:#f55; font-weight:bold; font-size:13px;")
        self.lbl_rec = QLabel("")
        self.lbl_rec.setStyleSheet("color:#f55; font-weight:bold; font-size:13px;")
        self.lbl_fps = QLabel("")
        self.lbl_fps.setStyleSheet("color:#888; font-size:12px;")
        for w in (self.lbl_cam, self.lbl_rec, self.lbl_fps):
            status.addWidget(w)
            status.addSpacing(20)
        status.addStretch()
    ...
    def _connect(self):
        ...
        self.lbl_cam.setStyleSheet("color:#0f0; font-weight:bold; font-size:13px;")
